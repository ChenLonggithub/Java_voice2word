...
/** * 创建日期:2018年1月14日 * 创建时间:下午10:09:39 * 创建者 :yellowcong * 机能概要:MP3转PCM Java方式实现 * http://ai.baidu.com/forum/topic/show/496972 */
public class AudioUtils {
    ...
    /** * MP3转换PCM文件方法 * * @param mp3filepath 原始文件路径 * @param pcmfilepath 转换文件的保存路径 * @return * @throws Exception */
    ...
    /** * 播放MP3方法 * * @param mp3filepath * @throws Exception */
...
// byte[] buffer = new byte[8192];
    ...
    /** * 创建日期:2018年1月14日<br/> * 创建时间:下午9:53:14<br/> * 创建用户:yellowcong<br/> * 机能概要:获取文件的音频流 * @param mp3filepath * @return */
    ...
    public static void main(String[] args) {
        ...
        utils.convertMP32Pcm("C:\\Users\\PlusTech\\Desktop\\测试.mp3", "C:\\Users\\PlusTech\\Desktop\\3.pcm");
    }
}