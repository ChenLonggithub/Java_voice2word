...
public class AsrMain {
    ...
    private final String APP_KEY = "0Ractl77lNIi0IlYijgcwPN0";

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
    private final String SECRET_KEY = "zc9hvsgfbmPPMvilXxUbGhGqF9PERVh7";

    // 需要识别的文件
    private final String FILENAME = "C:\\Users\\PlusTech\\Desktop\\test.pcm";
